...
def getDataFromSymbol(symbol):
    ...
    # shares_outstanding = \
    # data['context']['dispatcher']['stores']['QuoteSummaryStore']['defaultKeyStatistics']['sharesOutstanding']['raw']
    ...
    # earnings_per_share = \
    # data['context']['dispatcher']['stores']['QuoteSummaryStore']['defaultKeyStatistics']['trailingEps']['raw']
    # forward_annual_dividend_rate = \
    # data['context']['dispatcher']['stores']['QuoteSummaryStore']['summaryDetail']['dividendRate']['raw']
    # forward_annual_dividend_yield = \
    # data['context']['dispatcher']['stores']['QuoteSummaryStore']['summaryDetail']['dividendYield']['raw']
    #
    # # print the values
    # print 'Symbol:', symbol
    # print 'Name:', name
